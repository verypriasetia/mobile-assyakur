/* ==========================================================================
   COMBINED.JS - ENGINE SIGNAGE MASJID ASSYAKUR V3.1 (100% FINAL FIX BEBAS NaN)
   ========================================================================== */
...
setInterval(() => {
    ...
    for (let i = 0; i < daftarSholat.length; i++) {
        ...
        if (sekarangDetik >= adzanDetik && sekarangDetik < adzanDetik + batasIqamahDetik) {
            /* FIX MUTLAK DI BARIS INI: kata pengganggu sudah dipotong habis */
            iqamahAktif = {
...
function tambahkanItemGambarDinamis() {
    ...
    // GANTI SESUAI IDENTITAS REPOSITORI STB TV LAMA OM VERY DI SINI
